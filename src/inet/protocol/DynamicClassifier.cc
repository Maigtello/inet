...
#include "inet/protocol/DynamicClassifier.h"
...
{
    auto fragmentNumberHeader = packet->peekAtFront<FragmentNumberHeader>();
    auto sequenceNumberHeader = packet->peekAt<SequenceNumberHeader>(fragmentNumberHeader->getChunkLength());
